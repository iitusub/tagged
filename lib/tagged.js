...
tagged.add = function (name, o) {
    ...
    o.borderStyle = (o.borderStyle == 'inherit') ? o.style : tagged.parseStyle(o.borderStyle);
    
    o.borderLeft  = (o.borderLeft  === '') ? '' : (o.borderStyle + o.borderLeft  + constants.off);
    o.borderRight = (o.borderRight === '') ? '' : (o.borderStyle + o.borderRight + constants.off);
        ...
        if (typeof arguments[0].length !== 'number') {
            ...
            for (var key in x) {
                ...
                if (tag) {
                    ...
                    if ((!tag.zeroes) || (tag.align == 'center') || (tag.align == 'left') || (w > width))
